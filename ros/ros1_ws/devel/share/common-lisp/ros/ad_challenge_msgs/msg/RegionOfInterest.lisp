...
(cl:defmethod cl:initialize-instance :after ((m <RegionOfInterest>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RegionOfInterest)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ad_challenge_msgs-msg:<RegionOfInterest> is deprecated: use ad_challenge_msgs-msg:RegionOfInterest instead.")))

(cl:ensure-generic-function 'x_offset-val :lambda-list '(m))
(cl:defmethod x_offset-val ((m <RegionOfInterest>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ad_challenge_msgs-msg:x_offset-val is deprecated.  Use ad_challenge_msgs-msg:x_offset instead.")
  (x_offset m))

(cl:ensure-generic-function 'y_offset-val :lambda-list '(m))
(cl:defmethod y_offset-val ((m <RegionOfInterest>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ad_challenge_msgs-msg:y_offset-val is deprecated.  Use ad_challenge_msgs-msg:y_offset instead.")
  (y_offset m))
...
(cl:defmethod do_rectify-val ((m <RegionOfInterest>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ad_challenge_msgs-msg:do_rectify-val is deprecated.  Use ad_challenge_msgs-msg:do_rectify instead.")
  (do_rectify m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<RegionOfInterest>)))
  ...
  "ad_challenge_msgs/RegionOfInterest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'RegionOfInterest)))
  "Returns string type for a message object of type 'RegionOfInterest"
  "ad_challenge_msgs/RegionOfInterest")
