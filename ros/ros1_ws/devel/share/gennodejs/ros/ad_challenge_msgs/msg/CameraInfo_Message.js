...
class CameraInfo_Message {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CameraInfo_Message(null);
  ...
  static datatype() {
    ...
    return 'ad_challenge_msgs/CameraInfo_Message';
  }
  ...
  static messageDefinition() {
    ...
    ================================================================================
    MSG: ad_challenge_msgs/RegionOfInterest
  ...
  static Resolve(msg) {
    ...
    const resolved = new CameraInfo_Message(null);
...
module.exports = CameraInfo_Message;
