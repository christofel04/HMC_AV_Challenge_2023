...
let FullStateBBox3D = require('./FullStateBBox3D.js');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class FullStateBBox3DArray {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.boxes.forEach((val) => {
      bufferOffset = FullStateBBox3D.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new FullStateBBox3DArray(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.boxes[i] = FullStateBBox3D.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 232 * object.boxes.length;
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new FullStateBBox3DArray(null);
    ...
    if (msg.boxes !== undefined) {
      ...
      for (let i = 0; i < resolved.boxes.length; ++i) {
        resolved.boxes[i] = FullStateBBox3D.Resolve(msg.boxes[i]);
      }
    }
    else {
      resolved.boxes = []
...
module.exports = FullStateBBox3DArray;
