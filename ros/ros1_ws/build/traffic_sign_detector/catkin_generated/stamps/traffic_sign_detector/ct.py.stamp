...
def Transform_Traffic_Sign_Coordinate_to_Pixel_Camera_Coordinate_Coordinate( World_to_Camera_Matrix_Transformation_Matrix_Transformation , Traffic_Sign_Coordinate ):
    ...
    Traffic_Sign_Coordinate[ 2 ] = 1

    Traffic_Sign_World_Camera_Pixel_Coordinate_Coordinate = np.dot( World_to_Camera_Matrix_Transformation_Matrix_Transformation , Traffic_Sign_Coordinate )
...
class Autonomous_Vehicle_Position_And_Traffic() :
    ...
    def __init__( self ) :
        ...
        camera_info = message_filters.Subscriber('/Camera_1/camera_info' , CameraInfo_Message )
        #ts = message_filters.ApproximateTimeSynchronizer([ego_info, tsign_info], 1, 1)

        ts = message_filters.ApproximateTimeSynchronizer( [ tsign_info , camera_info ] , 1 , 1)
